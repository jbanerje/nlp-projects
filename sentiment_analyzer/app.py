...
#Logo
logo = './images/sentiment_analysis.jpg'
favicon = './images/sentiment_analysis_fav.png'
...
def sentiment_analysis_ui(neg_lex_list, pos_lex_list):
...
if __name__ == "__main__":
    ...
    sentiment_analysis_ui(neg_lex_list, pos_lex_list)